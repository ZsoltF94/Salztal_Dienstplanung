...
Status dieses Dokuments: Aktuell – System 09 mit technisch funktionsfähigem AG-14F-Ausgangsstand; S09A UI-05 wartet auf sichtbare Abnahme

## Aktueller Überblick

| Bereich | Aktueller Stand |
|---|---|
| Projektphase | Systeme 05, 06, 07 und 08 abgeschlossen; System 09 in Umsetzung |
| Aktives System | System 09 „Automatische Plangenerierung“ – eingefrorener Generator, UI-Zwischenschritt, Qualitätsbericht und spätere gezielte Optimierung vor AG-15 |
| Aktive Teil-Roadmaps | `docs/roadmaps/active/S09_AUTOMATIC_SCHEDULE_GENERATION_ROADMAP.md`; `docs/roadmaps/active/S09A_SCHEDULE_UI_RESTRUCTURING_ROADMAP.md` in Umsetzung |
| Aktueller Stand | Der technisch funktionsfähige Generator bleibt unverändert. S09A UI-01 bis UI-04 sind abgenommen. UI-05 vereinheitlicht die vorhandenen zerstörerischen Bestätigungen in einem modalen Panel über dem Dienstplan und ist automatisch geprüft. Vollständiger Build und alle 997 vorhandenen automatischen Prüfungen sind grün; die sichtbare UI-05-Abnahme ist offen. S09B wird erst nach Abschluss von S09A über Fragenkatalog und Roadmap konkretisiert. |
| Zuletzt abgenommener Schritt | S09A UI-04 am 2026-09-17 |
| Funktionsfähige App | Einsatzorte, Diensttyp-Standardzeiten, Mitarbeitende, regelmäßige Bedarfe, einzelne Tagesänderungen, der dreiwöchige Dienstplanentwurf mit Typ1 und Planungsvorbereitung sowie die Plangenerierung können im umgesetzten Umfang verwendet werden; die erneute sichtbare Generierung wurde bestätigt, ihre Ergebnisqualität und die übrigen AG-14F-Gates sind offen |
...
- Der Fragenkatalog für System 09 unter `docs/roadmaps/active/S09_AUTOMATIC_SCHEDULE_GENERATION_QUESTIONS.md` ist vollständig beantwortet, konsolidiert und als Grundlage des Roadmap-Entwurfs bestätigt.
- `docs/roadmaps/active/S09_AUTOMATIC_SCHEDULE_GENERATION_ROADMAP.md` gliedert System 09 in AG-01 bis AG-16 einschließlich AG-14A und des Änderungsblocks AG-14B bis AG-14F. AG-07 bis AG-14B wurden am 2026-09-17 ausdrücklich abgenommen. AG-14C bis AG-14E sind umgesetzt und automatisch geprüft. AG-14F hält den technisch funktionsfähigen, fachlich noch nicht angenommenen Ausgangsstand offen, bis S09A, S09B und die daraus abgeleitete Optimierungsentscheidung abgeschlossen sind.
- `docs/roadmaps/active/S09A_SCHEDULE_UI_RESTRUCTURING_ROADMAP.md` ist als reiner Desktop-Zwischenschritt innerhalb des offenen Systems 09 abgenommen und gestartet. UI-01 bestätigt den stabilen, eingefrorenen Generator und grenzt S09B, System 10 und System 11 weiterhin aus.
- UI-02 ist umgesetzt, automatisch geprüft und am 2026-09-17 sichtbar abgenommen: Auswahl und Tagesaktionen stehen unmittelbar vor der Drei-Wochen-Planung; Planungsvorbereitung, Generierung/Vorschau und vollständiges Verwerfen folgen darunter. Ein gemeinsamer vertikaler Arbeitsbereich hält alle Personenzeilen und unteren Karten erreichbar, während die Planung nur horizontal selbst scrollt.
- UI-03 ist umgesetzt, automatisch geprüft und am 2026-09-17 sichtbar abgenommen: Zulässige Typ1-Dienste öffnen direkt am gewählten Tagesfeld, die vorhandene Auswahl ist markiert und eine neue Auswahl speichert unmittelbar über den bestehenden Application-Ablauf. Die frühere getrennte Typ1-Karte samt eigener Speichern-/Entfernen-Schaltflächen ist entfernt. Nicht-Typ1- und automatisch geschützte Felder öffnen keine Dienstauswahl; vorhandene Tageswerte und `Leeren` bleiben am bestätigungspflichtigen Ablauf. WPF-Prüfungen decken Feldanker, Auswahl und `Escape` ab.
- UI-04 ist umgesetzt, automatisch geprüft und am 2026-09-17 sichtbar abgenommen: Grüne Erfolgs- und Informationsmeldungen überlagern den oberen Dienstplan, bleiben vier Sekunden lesbar und blenden über 350 Millisekunden weich aus. Rote Fehler bleiben am selben Ort dauerhaft sichtbar. Abbrechbare Zeitsteuerung und Meldungsfolgen verhindern, dass ein älterer Ablauf eine neuere Rückmeldung entfernt. Textstatus, Meldungstext und Automation-Live-Name machen die Bedeutung unabhängig von der Farbe verständlich.
- UI-05 ist umgesetzt und automatisch geprüft: Tageswert- und Typ1-Änderungen sowie das vollständige Verwerfen eines übernommenen automatischen Plans verwenden dieselbe modale Overlay-Darstellung. Der abgedunkelte Hintergrund sperrt Maus und widersprüchliche Befehle. `Abbrechen` erhält den sicheren Anfangsfokus; Fokusbindung, `Escape` und Fokuswiederherstellung sind umgesetzt. Die bisherigen fachlichen Warntexte und Folgen bleiben unverändert. ViewModel- und WPF-Prüfungen decken beide Bestätigungsarten, Abbruch ohne Änderung, Hintergrundsperre, Tastaturführung, Automation-Namen und dieselbe Panelinstanz ab. Alle 121 Desktop-Tests und insgesamt alle 997 vorhandenen Tests bestehen; das Excel-Testprojekt enthält weiterhin keine Tests. Sichtbare Prüfung und Abnahme bleiben offen.
- Nach S09A entsteht ein eigener Fragenkatalog für S09B. Der Qualitätsbericht misst zunächst den unveränderten Generator. Erst seine Ergebnisse begründen einen gesonderten Optimierungs- oder Rückfallplan; AG-15 prüft anschließend ausschließlich den endgültig vorgesehenen Algorithmus.
- AG-02 stellt die bestätigte Zielreihenfolge als ausführbaren OR-Tools-unabhängigen Vergleich bereit. Gleichrangige Regelarten erhalten keine versteckten Punkte oder Unterprioritäten. Öffentliche Planning-Verträge, reproduzierbare technische Zuweisungskennungen und ein erschöpfender synthetischer Kleinstfallrahmen sind vorhanden.
- AG-03 ordnet alle 28 Katalogregeln ausdrücklich einer technischen Wirkung zu und validiert Planning-Eingaben nochmals an der Modulgrenze. Unbekannte Versionen, unbekannte Regeln und bekannte nicht übersetzte Regeln bleiben getrennt; Zeitraum, Kennungen, Typbezüge, tatsächliche Zeiten, geschützte Typ1-Zuweisungen und die Wochenbereitschaft blockieren bei Widersprüchen gesammelt vor jedem Engine- oder Solverstart.
- AG-04 bildet ausschließlich zulässige normale, `D`- und `Spr`-Kandidaten aus technischen Momentaufnahmewerten. Geschützte Typ1-Deckungen werden vorab verbraucht, `B` bleibt bedarfsneutral, und atomare CP-SAT-Strukturgrenzen verhindern Doppelzuweisung und Überbesetzung. Tatsächliche Zeiten, gleichartige Plätze und technische Schlüssel bleiben reproduzierbar.
- AG-05 übersetzt alle elf automatischen Hard Rules explizit. Wirksames Wochen-Soll nach `U/K`, normale und AH-Obergrenzen, bekannte Vorgeschichte, Urlaubswochenende und bedarfsbezogene `Spr`-Notfallfreigabe sind unverletzbar. Eine unabhängige fachliche Nachprüfung und ein erschöpfender Kleinstfallvergleich erkennen kontrolliert fehlende Grenzen; bei unzulässiger Besetzung bleibt Bedarf offen.
- AG-06 minimiert zuerst offene Mitarbeiterzeit und danach vollständig offene Plätze. Reguläre Deckung wird vor `Spr` fixiert, die frühe `Spr`-Lücke bleibt sichtbar, normale, `D`- und `Spr`-Zuweisungen werden wertgleich zurückübersetzt und jeder sonst leere aktive Personentag erhält genau ein schwarzes `X`. Eine unabhängige Ergebnisprüfung und ein erschöpfender Referenzvergleich sichern die Rückübersetzung ab.
- AG-07 optimiert die fünf hohen Wünsche zuerst über die Gesamtzahl verletzter Fälle und danach ausschließlich über getrennte, nicht gewichtete Regelausmaße. Rote und schwarze `X` zählen als regulär frei, `U` und `K` nicht. Eine unabhängige Nachprüfung, ein erschöpfender Kleinstfall und eine kontrollierte Zielmutation sichern Modell und Ergebnis ab.
- AG-08 ergänzt ein vollständiges freies Wochenende, die `D`-Minimierung, die faire Verteilung von Früh-, Spät-, Wochenend-, `D`- und `Spr`-Einsätzen sowie einen stabilen technischen Gleichstand. Verglichen werden nur Personen mit derselben Zahl zulässiger Kandidatentage; AH bleibt bis zur nachgelagerten Phase ausgeschlossen.
- AG-09 friert die vollständige Nicht-AH-Auswahl ein und lässt AH anschließend nur verbleibende zulässige Plätze füllen. Restdeckung bleibt dominant, 720 Minuten je AH-Person und Woche sind unverletzbar, die Gesamtabweichung vom 600-Minuten-Ziel wird vor ihrer fairen Verteilung minimiert. Hinweise unter 360 sowie über 600 bis einschließlich 720 Minuten enthalten technische Personenkennung, Wochenmontag und Minutenwert.
- AG-10 koordiniert alle lexikografischen Solverstufen unter einer gemeinsamen Zeitgrenze und dokumentiert deterministische Einstellungen und OR-Tools-Version. Abbruch erreicht die native Solvergrenze und verwirft Zwischenstände. Ein zweiter paralleler Lauf wird abgelehnt; technische Fehlerwerte enthalten nur stabilen Code, Korrelationskennung und Ausnahmetyp. Ein fester Vorschlagsfingerabdruck schützt die Wiederholbarkeit über mehrere Läufe und neue Engine-Instanzen.
- AG-11 liest Entwurf und gespeicherte Vorbereitung vor jedem Start erneut, prüft ihre Wertgleichheit samt Typ1-Schutz und ruft Planning nur bei aktuellem Stand auf. Genau ein Lauf ist pro Prozess zulässig. Nur nachweislich optimale oder zulässige nicht nachweislich optimale Ergebnisse bleiben als flüchtige Vorschau im Application-Command; Verwerfen, Abbruch, Fehler und eine neue Command-Instanz schreiben nichts und halten keine Vorschlagshistorie.
- AG-12 ersetzt im Fachmodell ausschließlich ersetzbare automatische Zuweisungen und den vollständigen Bestand schwarzer `X`. Typ1-, manuelle und gesperrte Zuweisungen bleiben erhalten. Entwurfskennung, Version und Snapshot-Kennung werden vor der Übernahme erneut geprüft; doppelte oder veraltete Vorschläge werden weder teilweise übernommen noch automatisch zusammengeführt. Der vollständige neue Entwurf, Laufmetadaten und alle Erwartungswerte bilden einen einzigen Application-Schreibauftrag.
- AG-13 speichert diesen Auftrag in einer expliziten SQLite-Transaktion. Genau ein aktueller Laufdatensatz enthält Snapshot, Solver- und Laufwerte sowie den vollständigen Zielvektor. Reale SQLite-Prüfungen belegen Neustart-Round-trip, Ersatz eines früheren Laufs, Schutz gesperrter Werte, getrennte Konflikte und vollständiges Rollback bei einem Fehler in der Transaktionsmitte. Die neue Tabelle liegt in der einzigen gemeinsamen Migrationsfolge; ein Upgrade vom synthetischen System-08-Schemastand bewahrt den vorhandenen Entwurf.
- AG-14 ergänzt einen modularen WPF-Ablauf mit begründet aktivem Start, UI-thread-freiem Laufzustand und Abbruch, bewusster Vorschauentscheidung, verständlichen Konflikt- und Fehlercodes sowie der Darstellung automatischer Dienste und schwarzer `X`. Konkrete Planning- und SQLite-Adapter bleiben ausschließlich in `Desktop.Composition`; widersprüchliche Bearbeitungen sind während Lauf und Vorschau gesperrt.
- AG-14A ist als gewünschter Zwischenschritt vor AG-15 umgesetzt. Ein eigener Domain-Ablauf, Application-Command und SQLite-Schreib-Port entfernen das automatische Ergebnis im bestehenden Entwurf atomar, während Typ1, `U`, `K`, rote `X`, spätere manuelle Zuweisungen, Zeitraum und Bedarfe erhalten bleiben. Alle automatischen Zuweisungen einschließlich ihrer Sperren, schwarze `X`, Laufmetadaten und die Planungsvorbereitung werden entfernt. Die getrennte WPF-Komponente zeigt die tatsächlichen Anzahlen und den Erhaltungsumfang vor der Bestätigung; Abbrechen schreibt nichts und nach Erfolg ist eine bewusste neue Vorbereitung erforderlich. Abgenommene Planversionen bleiben unberührbar.
- Vor AG-15 wurde die fachliche Zielverteilung geändert. Der geplante Zielstand friert Nicht-AH nicht mehr vor AH ein, sondern optimiert beide Rollen gemeinsam. Nach Bedarfsdeckung und den bestehenden hohen Regeln werden zuerst `Spr` und `D` minimiert. Danach werden mindestens 180 AH-Minuten je Person und Woche angestrebt, ohne Nicht-AH unter `wirksames Wochensoll minus drei Stunden` zu drängen; anschließend werden alle relativ fair an ihr individuelles Wochenziel angenähert.
- AG-14C bis AG-14E haben Regelkatalogversion 2, den unabhängigen Zielvergleich, genau einen gemeinsamen Solver, neutrale Laufmetadaten und die verlustfreie Persistenz umgesetzt. Die fünfstufige Ablaufidee der Service-Leitung bleibt ausschließlich als Rückfall dokumentiert und wird erst nach ausdrücklicher Ablehnung der Primärlösung und einem eigenen Folgeplan implementiert.
- Der aktuelle Code lässt Nicht-AH und AH gemeinsam in einem globalen Modell zu. Er minimiert nach Deckung und hohen Regeln zuerst `Spr`, dann `D`, danach die AH-Mindestlücken und die relative Wochenzielabweichung. Die alte eingefrorene Nicht-AH-/AH-Phasenlogik und ihre ungenutzten Übersetzer sind entfernt.
- Der erste sichtbare AG-14F-Lauf endete mit `TechnicalFailure`. Die datensparsame Diagnose grenzte die Ursache auf die unabhängige Nachprüfung der Dienstberechtigung ein: Ein zulässiges `D`-Muster verlangte dort fälschlich zusätzlich die eigenständige Freigabe jedes Teildienstes. Die Nachprüfung unterscheidet jetzt normale Dienste, `D` und `Spr` entsprechend ihren bestätigten Regeln. Der zuvor fehlschlagende lokale Vorbereitungsstand liefert bei einer ausschließlich lesenden Wiederholung innerhalb einer verkürzten Diagnosegrenze regulär `FeasibleNotProvenOptimal`.
- Die Service-Leitung hat am 2026-09-17 bestätigt, dass die erneute sichtbare Generierung funktioniert. Das erzeugte Ergebnis ist nach ihrer Bewertung noch nicht optimal und noch nicht fachlich gut; diese Qualitätsaussage ist keine Abnahme der Primärlösung und wird in den weiteren Schritten berücksichtigt.
- Technische Planungsfehler werden nun lokal, größenbegrenzt und unter ihrer sichtbaren Korrelationskennung protokolliert. Erfasst werden nur technische Stufe, Fehlerwert, Ausnahmetyp, Aufrufnamen und streng gefilterter technischer Kontext; Ausnahmetexte, Dateipfade, Namen und Planinhalte bleiben ausgeschlossen.
- Der aktuelle Nachweis umfasst einen vollständigen Solution-Build ohne Warnungen oder Fehler sowie 359 Domain-, 285 Application-, 132 Planning-, 81 Infrastructure-, 106 Desktop- und 19 Architekturtests, insgesamt 982 bestandene Tests. Echte SQLite-Prüfungen belegen Neustart, Ersatz, vollständiges Rollback, das verlustfreie Laufzeit-Upgrade und den vollständigen Zielvektor. Das leere Excel-Testprojekt wird weiterhin mit dem vereinbarten Exitcode behandelt.
...
- `Spr` deckt erst ab dem tatsächlichen Wechsel und lässt die frühere Restaurantzeit sichtbar ungedeckt. `Spr`, `D` und Spätdienste werden als ungünstige Einsätze berücksichtigt; `Spr` und `D` werden ausschließlich durch ihre bestätigten Regeln besonders vermieden. Unterschiedliche Regelarten derselben Priorität erhalten keine versteckten Gewichte. Ein späteres Punktesystem und bewusst alternative gleichwertige Pläne bleiben vorgemerkte Erweiterungen.
- Für System 10 ist eine vollständige Bedarfsdeckungsübersicht bestätigt. Sie führt nach jeder erfolgreichen Generierung alle wirksamen Bedarfe der drei Wochen einzeln auf, unterscheidet vollständig gedeckt, ausschließlich bei `Spr` teilweise gedeckt und ungedeckt und nennt benötigte, gedeckte und offene Personen beziehungsweise Minuten sowie Gesamtsummen. Ursachen und Lösungsmöglichkeiten werden für teilweise oder vollständig offene Bedarfe ergänzt.
- Die Roadmap verlangt neben Regel- und Solverprüfungen einen unabhängigen Kleinstfall-Referenzlöser, deterministisch generierte Invariantenfälle, kontrollierte Mutationsnachweise, reale SQLite-Transaktionstests, reproduzierbare Lastfälle und ein sichtbares WPF-Gate.
...
- S09A-UI-Umbau, der noch zu klärende S09B-Planungsqualitätsbericht, gezielte Optimierung und der abschließende AG-15-/AG-16-Nachweis
- Fachliche Konfliktübersicht und allgemeine manuelle Planbearbeitung der Systeme 10 und 11 sowie Planabnahme und Export der Systeme 12 bis 14
...
- Die gemeinsame SQLite-Speicherung für Servicekatalog, Mitarbeitertypen, Einsatzfreigaben, Mitarbeitende und automatische Planung ist mit leeren sowie aktualisierten temporären Testdateien geprüft. Die Planungsengine ist implementiert und automatisch geprüft; ihr aktuelles fachliches und sichtbares AG-14F-Gate sowie der spätere Excel-Export stehen noch aus.
- S09A UI-04 ist sichtbar abgenommen. UI-05 ist umgesetzt und automatisch geprüft; offen ist die sichtbare Bedienprüfung aller Bestätigungen mit Maus und Tastatur. Erst danach beginnt UI-06.
...
System 08 und PM-01 bis PM-10 sind vollständig geprüft, ausdrücklich abgenommen und archiviert. AG-07 bis AG-14B wurden am 2026-09-17 ausdrücklich abgenommen. AG-14C bis AG-14E, die automatischen Vergleichsfälle aus AG-14F und die im ersten sichtbaren Lauf gefundene Fehlerkorrektur sind mit 982 Ausgangstests sowie einem vollständigen Solution-Build geprüft. Die erneute sichtbare Generierung funktioniert; ihre Ergebnisqualität ist noch nicht abgenommen. S09A UI-01 bis UI-04 sind abgenommen. UI-05 ist umgesetzt, mit vollständigem Build und 997 automatischen Prüfungen grün und wartet auf die sichtbare Bedienprüfung des gemeinsamen modalen Bestätigungspanels. Danach ist UI-06 der nächste minimale Implementierungsschritt. Während S09A bleibt der Generator unverändert. Erst nach dem vollständigen S09A-Abschluss werden Inhalt und Abnahmebedingungen von S09B in einem eigenen Fragenkatalog geklärt. AG-15 bleibt bis zum Bericht, einem daraus abgeleiteten Folgeplan und der Annahme des endgültig vorgesehenen Algorithmus gesperrt.
