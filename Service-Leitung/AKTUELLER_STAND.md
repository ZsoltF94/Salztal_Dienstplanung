...
Die Fragen für System 09 „Automatische Plangenerierung“ sind vollständig beantwortet. Die bisher umgesetzte Roadmap beschreibt die feste Prioritätsreihenfolge und die damals getrennte Planung von Nicht-AH und AH, die bewusste Vorschau und Übernahme sowie besonders umfangreiche Korrektheitsprüfungen. Die Roadmap und die technische Rechen- und Speicherstrecke bis AG-13 wurden am 17. September 2026 ausdrücklich abgenommen. AG-14 ergänzt die sichtbare Bedienung: Die Service-Leitung sieht, warum ein Lauf noch nicht starten darf, kann einen vorbereiteten Lauf starten und abbrechen und erhält danach eine verständliche Vorschau mit Laufzeit, offenen Bedarfen, erzeugten Einteilungen und schwarzen `X`. Der Vorschlag wird erst nach „Plan übernehmen“ gespeichert oder mit „Vorschlag verwerfen“ verworfen. Während Lauf und Vorschau sind widersprüchliche Änderungen gesperrt. Automatische Prüfungen sind vollständig grün; die erneute sichtbare Generierung funktioniert, weitere einzelne Bedien- und Qualitätsabnahmen stehen noch aus.

Vor dem großen Abschlussnachweis wurde auf Wunsch der Service-Leitung AG-14A umgesetzt. Damit kann auch ein bereits übernommener automatischer Plan vollständig verworfen werden, um bewusst wieder von vorne anzufangen. Typ1, `U`, `K`, rote `X`, spätere manuelle Einteilungen, Zeitraum und Bedarfe bleiben erhalten. Alle automatisch erzeugten Einteilungen einschließlich ihrer Sperren, schwarze `X`, Laufdaten und die Vorbereitung werden nach einer deutlichen Bestätigung gemeinsam entfernt. Die Warnung nennt vorher die tatsächliche Zahl der Einteilungen und schwarzen `X`; Abbrechen ändert nichts. Danach muss bewusst neu vorbereitet werden. Abgenommene Planversionen bleiben geschützt. Die Funktion ist mit echten temporären Datenbanken, vollständigem Fehlerrücklauf und sichtbaren Oberflächenprüfungen automatisch getestet; die persönliche sichtbare Bestätigung steht noch aus.

Vor dieser sichtbaren Prüfung wurde die gewünschte Verteilung noch einmal geändert. Künftig sollen Nicht-AH und AH gemeinsam betrachtet werden. Bei gleicher bestmöglicher Bedarfsdeckung und nach den hohen Schutzwünschen werden zuerst Springer und danach Doppeldienste möglichst vermieden. Jede AH-Person soll bei passenden Diensten möglichst mindestens drei Stunden je Woche erhalten. Dafür darf eine Nicht-AH-Person unter dem exakten Wochensoll bleiben, aber nicht unter Wochensoll minus drei Stunden gedrängt werden. Anschließend werden alle Personen relativ fair an ihre eigenen Wochenstunden herangeführt.

AG-14B wurde ausdrücklich abgenommen. Die neue Regelversion, der gemeinsame Nicht-AH-/AH-Algorithmus und die verlustfreie Speicherung sind inzwischen umgesetzt und automatisch geprüft. Die erneute sichtbare Generierung funktioniert, das Ergebnis ist nach Bewertung der Service-Leitung aber noch nicht optimal und noch nicht gut genug. Die von der Service-Leitung beschriebene fünfstufige Reihenfolge bleibt als Rückfall notiert und wird nur nach einer späteren ausdrücklichen Entscheidung und einem eigenen Folgeplan gebaut.

Die fünf vollständig erfundenen Vergleichsfälle stehen in `docs/decisions/S09_JOINT_OPTIMIZATION_ACCEPTANCE_SCENARIOS.md`. Sie zeigen normale AH-Integration, knappen Bedarf, vollständig offenen unzulässigen Bedarf, ein erforderliches `D` und ein Notfall-`Spr` mit sichtbarer früher Lücke.

Der weitere Weg ist deshalb neu geordnet: Der Generator bleibt zunächst fachlich unverändert. S09A hat die vorhandene Dienstplanoberfläche rein visuell und in ihrer Bedienreihenfolge umgebaut und ist vollständig abgenommen. Der S09B-Fragenkatalog, die Roadmap sowie QB-01 bis QB-05 sind ebenfalls ausdrücklich abgenommen. QB-05 bilanziert jeden erfolgreichen oder erfolglosen Generierungsversuch in 15 festen Planungsschritten. QB-06 macht diese Bilanz und die neutralen Planungswerte nun in einem eigenen Fenster sichtbar. Das Fenster bleibt neben dem Dienstplan geöffnet und bedienbar, wird bei erneutem Aufruf nicht dupliziert und zeigt einen früheren Bericht nach späteren Planänderungen nicht still als aktuell. Der beim ersten sichtbaren Wechsel in „Generierung“ gemeldete Absturz wurde reproduziert und korrigiert. Die anschließende Sichtprüfung hat zwei weitere, reine Berichtslücken gezeigt: Im gespeicherten Bericht wird die tatsächlich ausgeführte Eingangsprüfung fälschlich als „Nicht erreicht“ angezeigt. Außerdem nennt eine nach 120 Sekunden beendete Optimierungsphase noch nicht, dass die Zeitgrenze den Optimalitätsbeweis beendet hat und deshalb alle folgenden Schritte gar nicht begonnen wurden. QB-06A ist als fünfteiliger Korrekturplan freigegeben. QB-06A.1 bis QB-06A.4 sind abgenommen: Die Planung führt die erfolgreiche Eingangsprüfung in derselben Phasenfolge wie der Vorschlag, hält bei einer Solverunterbrechung den belegten Grund, das gerade aktive Ziel, die Zeitgrenze, die verbrauchte Zeit und vorhandene Werte der behaltenen zulässigen Auswahl fest, lädt diese Angaben nach einem Neustart unverändert wieder und formuliert daraus verständliche Erklärungen. QB-06A.5 zeigt diese Erklärungen nun im Generierungsbereich. Dort stehen zusätzlich die Einordnung vorhandener Werte und bei älteren Läufen der ehrliche Hinweis, dass Detaildaten nicht gespeichert wurden; „Nicht erreicht“ wird dafür nicht mehr pauschal verwendet. Dabei wurden Berechnung, 120-Sekunden-Grenze und Auswahl nicht verändert, kein zusätzlicher Solverlauf und keine Berichtshistorie ergänzt. Die gemeinsame sichtbare Prüfung dieser Anzeige steht noch aus. Erst der vollständig sichtbar beurteilte Bericht begründet einen eigenen Plan für gezielte Verbesserungen oder den dokumentierten Rückfall. Die große Korrektheits- und Leistungsprüfung AG-15 erfolgt erst für die danach endgültig vorgesehene Berechnung.

Die neutrale Bedarfs- und Deckungsdarstellung sowie die Personen-, Wochenzeit- und Dienstzählwerte sind für drei Wochen im neuen Berichtsfenster vorhanden. System 10 ergänzt später die verständlichen Ursachen und Lösungsmöglichkeiten für offene Bedarfe.
...
- Alle 982 automatischen Prüfungen einschließlich der neuen gemeinsamen Optimierung, ihrer fünf fachlichen Vergleichsfälle und der Korrektur der `D`-Berechtigungsprüfung sind grün. Das für eine spätere Excel-Vorlage vorgesehene Excel-Prüfprojekt ist weiterhin leer und wird im Gesamtlauf berücksichtigt.
...
System 08 ist vollständig abgeschlossen. Die erneute sichtbare Generierung funktioniert; das Ergebnis ist nach Bewertung der Service-Leitung aber noch nicht optimal und noch nicht gut genug. S09A ist vollständig umgesetzt, sichtbar abgenommen und archiviert. Der S09B-Fragenkatalog, die Roadmap und QB-01 bis QB-05 sind abgenommen. QB-06 mit dem eigenen nicht-modalen Berichtsfenster ist technisch umgesetzt und vollständig automatisch geprüft. Die sichtbare Prüfung hat zwei Berichtslücken bestätigt. QB-06A.1 bis QB-06A.4 sind abgenommen. QB-06A.5 zeigt die belegten Unterbrechungsangaben, die Einordnung des zulässigen Zwischenstands und die deshalb nicht begonnenen Folgephasen nun verständlich im vorhandenen Berichtsfenster und kennzeichnet ältere fehlende Details ehrlich. Sieben gezielte ViewModel- und Oberflächenfälle sind grün. Als Nächstes folgt die gemeinsame sichtbare Bedien- und Lesbarkeitsprüfung bei normaler und kleiner Fenstergröße. Auf Grundlage des später vollständig abgenommenen Berichts entsteht ein eigener Plan für gezielte Verbesserungen oder die dokumentierte Rückfalllösung. AG-15 prüft anschließend den endgültig vorgesehenen Algorithmus.
