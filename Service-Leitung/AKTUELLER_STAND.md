...
Der weitere Weg ist deshalb neu geordnet: Der Generator bleibt zunächst unverändert. S09A ist als reiner Umbau der vorhandenen Dienstplanoberfläche gestartet. Der erste Abgleich, die neue Reihenfolge, die Typ1-Auswahl direkt am Tagesfeld und die platzneutralen Rückmeldungen sind abgenommen. Tageswerte, Typ1-Dienste und das vollständige Verwerfen eines übernommenen automatischen Plans verwenden nun dasselbe große Bestätigungsfeld über dem Dienstplan. Solange es geöffnet ist, bleibt der Hintergrund gesperrt. `Abbrechen` ist zuerst ausgewählt, `Escape` bricht ab und der Fokus kehrt anschließend an die vorige Stelle zurück. Warntexte und die tatsächlichen Folgen der Aktionen wurden nicht verändert. Dieser fünfte Schritt ist automatisch geprüft und wartet auf die persönliche Bedienprüfung. Danach wird in einem eigenen Fragenkatalog gemeinsam festgelegt, welche Werte der S09B-Qualitätsbericht zeigen soll. Erst dieser Bericht begründet einen eigenen Plan für gezielte Verbesserungen oder den dokumentierten Rückfall. Die große Korrektheits- und Leistungsprüfung AG-15 erfolgt erst für die danach endgültig vorgesehene Berechnung.

Für System 10 ist zusätzlich bestätigt: Nach jeder erfolgreichen Generierung soll eine genaue Übersicht alle Bedarfe der drei Wochen zeigen. Sie unterscheidet vollständig gedeckte, beim Springer teilweise gedeckte und ungedeckte Bedarfe und nennt je Bedarf die benötigten, gedeckten und offenen Personen beziehungsweise Minuten. Gesamtsummen sowie verständliche Ursachen und Lösungsmöglichkeiten für offene Bedarfe kommen hinzu. Diese ausführliche Übersicht ist noch nicht gebaut und gehört nicht zum offenen sichtbaren AG-14-Gate.
...
System 08 ist vollständig abgeschlossen. AG-14B wurde ausdrücklich abgenommen; AG-14C bis AG-14E und die automatischen AG-14F-Vergleichsfälle sind mit insgesamt 982 Ausgangsprüfungen grün. Der erste sichtbare Planungslauf hat einen technischen Fehler gezeigt, ohne den Entwurf zu verändern: Ein erlaubter Doppeldienst wurde bei einer zusätzlichen Sicherheitsprüfung fälschlich wie zwei einzeln erlaubte Dienste behandelt. Diese Prüfung ist korrigiert. Die Service-Leitung hat anschließend bestätigt, dass die App sichtbar wieder einen Plan erzeugen kann. Das Ergebnis ist nach ihrer Bewertung aber noch nicht optimal und noch nicht gut genug. In S09A sind UI-01 bis UI-04 abgenommen. UI-05 mit einem gemeinsamen modalen Bestätigungspanel ist umgesetzt; alle 121 Desktop-Prüfungen und insgesamt alle 997 vorhandenen automatischen Prüfungen sind grün. Als Nächstes werden Tageswert-, Typ1- und vollständige Verwerfbestätigungen sichtbar mit Maus und Tastatur beurteilt. Während dieses reinen UI-Umbaus bleibt die Berechnung unverändert. Danach folgt UI-06 mit gemeinsamer Sichtprüfung und kleinen Höhenoptimierungen. Erst nach dem vollständigen S09A-Abschluss werden Fragenkatalog und Roadmap für den S09B-Qualitätsbericht erstellt. Auf Grundlage dieses Berichts entsteht ein eigener Plan für gezielte Verbesserungen oder die dokumentierte Rückfalllösung. AG-15 prüft anschließend den endgültig vorgesehenen Algorithmus.
